import { FieldNode, FragmentSpreadNode, GraphQLResolveInfo, InlineFragmentNode, SelectionNode } from "graphql";
...
export const mapSelections = (info: GraphQLResolveInfo): MapSelectionsReturnType => {
    if (!info) return;
